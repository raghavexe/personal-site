  ...
  return (
    <nav className="w-full h-16 px-6 flex items-center justify-between bg-grimdark-metal text-white z-1">
      ...
      <div className="hidden md:flex gap-6 text-sm text-gray-300">
        <Button sectionId="home" text="HOME" active={true} />
        <Button sectionId="about" text="ABOUT" active={false} />
        <Button sectionId="projects" text="PROJECTS" active={false} />
        <Button sectionId="hobbies" text="HOBBIES" active={false} />
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <Button sectionId="contact" text="contact" active={false}></Button>
      </div>
    </nav>
  );
}
